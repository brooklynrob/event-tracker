...
[  
    {
        "source"=> "eventful",
        "url_api"=> "http://api.eventful.com/json/events/search?app_key=LF6rm2crQzTbMZ2X&location=New+York"
    },
    {
        "source"=> "eventful",
        "url_api"=> "https://api.seatgeek.com/2/events?venue.state=NY"
    }
]
...
seed_sources.each do |source|
  puts  "About to URL at #{source.source}"
  puts  "About to URL at #{source.url_api}"
...
# Extra stuff
# dynamically build URL - add app key if exists


# Change to existing table
# Change title of seatgeekid to sourceid
# Add source
